...
public class BeerControllerTest {
    ...
    void setUp() {
        mockMvc = MockMvcBuilders.standaloneSetup(beerController)
                .setCustomArgumentResolvers(new PageableHandlerMethodArgumentResolver())//colocar objetos pagináveis
    ...
    void whenPOSTIsCalledThenABeerIsCreated() throws Exception {
        ...
        //postman último nível da piramide - teste de integração

        // then
        mockMvc.perform(post(BEER_API_URL_PATH)
                .contentType(MediaType.APPLICATION_JSON)
                .content(asJsonString(beerDTO)))//passar o conteúdo do content
                .andExpect(status().isCreated())
                .andExpect(jsonPath("$.name", is(beerDTO.getName())))//o que espera que retorna
                .andExpect(jsonPath("$.brand", is(beerDTO.getBrand())))
                .andExpect(jsonPath("$.type", is(beerDTO.getType().toString())));
    }

    @Test
    void whenPOSTIsCalledWithoutRequiredFieldThenAnErrorIsReturned() throws Exception { //valida preenchimento de campos
        // given
        BeerDTO beerDTO = BeerDTOBuilder.builder().build().toBeerDTO();
        ...
        mockMvc.perform(post(BEER_API_URL_PATH)
                ...
                .andExpect(status().isBadRequest()); //espera que retorne o 404 - bad request
    }

    @Test
    void whenGETIsCalledWithValidNameThenOkStatusIsReturned() throws Exception {//validar status de retorno e corpo de objeto
        // given
        BeerDTO beerDTO = BeerDTOBuilder.builder().build().toBeerDTO();
